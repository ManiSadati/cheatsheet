...
opt -S -enable-new-pm=0 -load ../../Assignment.so -faultinjection -fi-type=0 < Quicksort.ll > Quicksort_Instr.ll
clang Quicksort_Instr.ll ../../FaultInjection.so -o Quicksort.o
